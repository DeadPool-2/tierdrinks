...
**Фичи:**
- **Коллекции брендов** — двухуровневый фильтр бренд→линейка (Monster: Ultra/Juiced/Rehab/Java/Reserve; Red Bull: Classic/Editions).
- **Лог дегустаций** — каждая оценка = выпитая банка с датой; попробовал снова → новая запись. История вкуса со спарклайном.
- **Цена вручную + тренд** — датированные точки цены, мини-график динамики.
- **Раздел «Всё»** — счётчик выпитого по брендам, любимые офиц. вкусы, динамика цен, совпадение вкусов двоих.
